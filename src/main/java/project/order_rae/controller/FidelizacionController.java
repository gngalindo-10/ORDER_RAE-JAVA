...
public class FidelizacionController {
    ...
    public String guardar(
        ...
        redirectAttrs.addFlashAttribute("mensaje", "Fidelizacion creada exitosamente.");
    ...
    public String actualizar(
        ...
        redirectAttrs.addFlashAttribute("mensaje", "Fidelizacion actualizada exitosamente.");
        return "redirect:/fidelizacion";
    }
    ...
    public String eliminar(@PathVariable Long id, RedirectAttributes redirectAttrs) {
        ...
        redirectAttrs.addFlashAttribute("mensaje", "Fidelizacion eliminada exitosamente.");
        return "redirect:/fidelizacion";
    }
}